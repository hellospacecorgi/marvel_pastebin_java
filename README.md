# 🦸🏻‍♂️ Marvel-Pastebin Java Application README 🦸🏻‍♀️
...
As part of the unit's focus on design patterns and principles, the MVP architecture and Facade pattern was applied to achieve maintanability, extensibility and modularity of the software. The project was developed following test-driven development practices, and used JUnit and Mockito for testing, and testing coverage can be viewed with Jacoco or Gradle test reports. 
